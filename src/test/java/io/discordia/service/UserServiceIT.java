 ...
 */
@SpringBootTest(classes = {TabBackendApiApp.class, TestSecurityConfiguration.class})
@Transactional
public class UserServiceIT {
    ...
    /**
     * This repository is mocked in the io.discordia.repository.search test package.
     *
     * @see io.discordia.repository.search.UserSearchRepositoryMockConfiguration
     */
    @Autowired
