...
@RestController
@RequestMapping("/api/tab-backend-api-kafka")
public class TabBackendApiKafkaResource {

    private final Logger log = LoggerFactory.getLogger(TabBackendApiKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public TabBackendApiKafkaResource(KafkaProperties kafkaProperties) {
